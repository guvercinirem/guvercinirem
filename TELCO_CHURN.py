...
df=pd.read_csv("MIUUL/MACHİNE_LEARNING_/Telco-Customer-Churn.csv")
df.head()  #Churn ana değişkenimiz Yes ve no lardan oluşuyor.
df.isnull().sum()
"""TotalCharges        11"""
df.info()
...
---  ------            --------------  -----  
 ...
 20  Churn             7043 non-null   object """  #TotalCharges sayısal bir değişken olmalı

df["TotalCharges"]=pd.to_numeric(df["TotalCharges"],errors='coerce')
#Churn Target- ana değişkenimiz.Modelin anlayacağı bir şekle getirmemiz gerek.
...
#Önce veride herhangi bir değişken üretmenden accuracy değerlerimizi görmek için
#base model üretelim
...
#Yeni değişkenler üretme kısmına geldik,
# hem modelin başarısını arttırmak için
# hem de overfitte düşmemesi için
