...
#Out[66]: 0.7058568882098294
cv_results["test_f1"].mean()
#Out[67]: 0.5710621194523633
...
#Out[8]: {'max_depth': 5, 'min_samples_split': 4}

cart_best_grid.best_score_

#Out[9]: 0.7500806383159324
...
cart_model=cart_model.set_params(**cart_best_grid.best_params_).fit(X,y)

cv_results=cross_validate(cart_final,X,y,cv=5,scoring=["accuracy","f1","roc_auc"])


cv_results["test_accuracy"].mean() #Out[16]: 0.7500806383159324

cv_results["test_f1"].mean()#Out[17]: 0.614625004082526

cv_results["test_roc_auc"].mean()#Out[18]: 0.797796645702306
